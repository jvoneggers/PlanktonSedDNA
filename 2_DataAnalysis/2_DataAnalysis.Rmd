...
ggsave("3_Figures/FigX_V7_phytoplankton_top_relative_abundance.png",height=10, width=9, units="in")
...
tax_table(ps_V7_norm_sub) <- tax_table(tax_fun) # replace taxonomy table in the phyloseq object
rm(tax_fun)
ps_V7_norm_sub<- subset_taxa(ps_V7_norm_sub, !trophic_mode %in%c("phototrophs","phototrophs/mixotrophs","mixotrophs") &  !subdivision=="Metazoa")
```
...
ggsave("3_Figures/FigX_V7_heterotrophic_protists_top_relative_abundance.png",height=10, width=9, units="in")
...
taxa_colors<-palette.colors(palette = "Okabe-Ito")
taxa_colors<-c("#000000", "#E69F00" ,"#56B4E9" ,"#009E73" ,"#D55E00" ,"#F0E442" ,"#0072B2")
...
ggsave("3_Figures/FigX_V7_zooplankton_top_relative_abundance.png",height=10, width=9, units="in")
...
ggsave("3_Figures/FigX_V9_phytoplankton_top_relative_abundance.png",height=10, width=9, units="in")
...
tax_table(ps_V9_norm_sub) <- tax_table(tax_fun) # replace taxonomy table in the phyloseq object
rm(tax_fun)
ps_V9_norm_sub<- subset_taxa(ps_V9_norm_sub, !trophic_mode %in%c("phototrophs","phototrophs/mixotrophs","mixotrophs") &  !subdivision=="Metazoa")
```
...
ggsave("3_Figures/FigX_V9_heterotrophic_protists_top_relative_abundance.png",height=10, width=9, units="in")
...
```{r}
taxa_colors<-palette.colors(palette = "Okabe-Ito")
taxa_colors<-c("#000000", "#E69F00" ,"#56B4E9" ,"#009E73" ,"#D55E00" ,"#F0E442" ,"#0072B2","gray")
...
ggsave("3_Figures/FigX_V9_zooplankton_top_relative_abundance.png",height=10, width=9, units="in")
...
After this, switch the sign for nitrogen deposition and add in the climate part
next do the zooplankton BLAST
